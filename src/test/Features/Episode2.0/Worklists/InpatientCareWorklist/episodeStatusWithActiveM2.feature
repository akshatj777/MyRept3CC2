...
Feature: Patient status in Inpatient Care Worklist(Model 2 Episode status)

  Scenario Outline: Verify patient should be present in inpatient care worklist with HHH- Inpatient with confirmed Possible/Working/Final BPCI M2 DRG.
