...
Feature: Verify Readmission status with anchor discharge
  ...
  Scenario: Patient with anchor discharge, readmission in different facility.
  ...
  Scenario: Verify Readmission status with anchor discharge, readmission in same facility
    Given I am on the login page
    When I enter email field qa.admin@yopmail.com for login
    And I enter password field Episode1! for Login
    Then I click Access button
