...
Then I click on the filterd patient on the patient card page
    ...
    Then I select the "Discharge" "caresetting" "EXPIRED - Expired" by "#bp_personbundle_bpadmissiontype_dischargeFacilityCategory" on add a new transition
    Then I wait to the see the visibility of loader to disappear
    Then I select the "Discharge" "caretype" "Expired as Inpatient" by "#bp_personbundle_bpadmissiontype_dischargeCareType" on add a new transition
    Then I wait to the see the visibility of loader to disappear
