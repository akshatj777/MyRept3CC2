...
Feature: Model 2 Readmission
  ...
  Scenario: Patient with Active Episode and readmission to an ACH facility as HHH-I without DRG
  ...
  Scenario: Patient with Pend Can Episode and readmission to an ACH facility as HHH-I without Drg
    Given I am on the login page
    When I enter email field qa.admin@yopmail.com for login
    And I enter password field Episode1! for Login
    Then I click Access button
  ...
  Scenario: Patient with Pend Canc Episode having readmission to an ACH facility as HHH-I with BPCI DRG
    Given I am on the login page
    When I enter email field qa.admin@yopmail.com for login
    And I enter password field Episode1! for Login
    Then I click Access button
