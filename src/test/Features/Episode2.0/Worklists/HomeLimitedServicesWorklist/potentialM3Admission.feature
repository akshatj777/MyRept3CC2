...
Feature: Patient status on Home Limited Service Worklist(Potential M3 Episode status)

  Scenario: Verify patient should be present in Home Limited Services worklist when Episode is Potential M3 Pend Canc and patient is readmitted to REH - Rehabilitation
  ...
  Scenario: Verify While patient in Home With Limited Services worklist add another admission and transition get updated with other care setting
    Given I am on the login page
    When I enter email field qa.admin@yopmail.com for login
    And I enter password field Episode1! for Login
    Then I click Access button
  ...
  Scenario: Verify patient should be present in Home With Limited Services worklist when Episode is Potential M3 Active and patient is discharge to REH - Rehabilitation
    Given I am on the login page
    When I enter email field qa.admin@yopmail.com for login
    And I enter password field Episode1! for Login
    Then I click Access button
