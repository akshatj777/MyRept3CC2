...
Feature: Patient status on Home Limited Service Worklist (Past Transition admission)

  Scenario: Patient's with past transition admit care setting is HOM / REH (Outpatient)
