Feature: Episode 2.0 Care Plan Filters
  ...
  Scenario: Verify Admit Reason filter is present under list of Filter options on Patient Page
    ...
    Then I switch to PatientTransitions frame
    Then I wait to the see the visibility of loader to disappear
    Then I will wait to see and click on "Assign button" with attribute "ng-click" "assignCarePlan()" in "a" tag
    Then I wait to the see the visibility of loader to disappear
    Then I will "check in" the "Acute Myocardial Infarction" radio button at index "1"
    Then I will wait to see and click on "Save Changes" with attribute "ng-click" "assignCarePlans()" in "button" tag
    Then I will wait to see "Acute Myocardial Infarction" followed by "h4" tag
    When I switch to default window from iframe
    Then I close the patient summary Page
    Then I scroll the page to bottom by "-100"
    When I click on Filter button present on Patient Page
